        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupQuizzes_AspNetUsers_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favorites", x => new { x.UserId, x.ContentId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WatchlistItems", x => new { x.UserId, x.ContentId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "GroupQuizParticipants",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GroupQuizId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    JoinedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupQuizParticipants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupQuizParticipants_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupQuizParticipants_GroupQuizzes_GroupQuizId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizSessions_GroupQuizzes_GroupQuizId",
                        column: x => x.GroupQuizId,
                        principalTable: "GroupQuizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizVotes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_QuizVotes_Contents_ContentId",
                        column: x => x.ContentId,
                        principalTable: "Contents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuizVotes_QuizSessions_QuizSessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupQuizParticipants_GroupQuizId",
                table: "GroupQuizParticipants",
                column: "GroupQuizId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupQuizParticipants_UserId",
                table: "GroupQuizParticipants",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupQuizzes_CreatorId",
                table: "GroupQuizzes",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizSessions_GroupQuizId",
                table: "QuizSessions",
                column: "GroupQuizId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizVotes_ContentId",
                table: "QuizVotes",
                column: "ContentId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizVotes_QuizSessionId",
                table: "QuizVotes",
                column: "QuizSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizVotes_UserId",
                table: "QuizVotes",
                column: "UserId");
